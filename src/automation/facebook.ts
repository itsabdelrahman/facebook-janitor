 ...
 */
export const navigateToProfile = async (page: Page): Promise<Page> => {
 ...
 */
export const navigateToActivityLog = async (page: Page): Promise<Page> => {
 ...
 */
export const deleteFirstPost = async (page: Page): Promise<Page> => {
